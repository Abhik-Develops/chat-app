...
import { Box, IconButton, Typography, CircularProgress, FormControl, TextField, InputAdornment, Alert, Avatar, Button } from '@mui/material';
    ...
    <>
        {
            selectedChat ? (
                <>
                                ...
                                <>
                                    <ProfileModal user={getSenderInfo(user, selectedChat.users)}>
                                        <Box sx={{display: 'flex', alignItems: 'center', cursor: 'pointer'}}>
                                            ...
                                            <Typography variant='h5' sx={{fontFamily: 'Wrok sans', width: '100%', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis'}}>
                    ...
                    <Box sx={{display: 'flex', flexDirection: 'column', justifyContent: 'flex-end', p: 3, bgcolor: '#E8E8E8', width: '100%', height: '100%', borderRadius: '10px', overflowY: 'hidden'}}>
                        {
                            loading ? <CircularProgress size={60} thickness={2} sx={{alignSelf:'center', margin:'auto', color:'black'}}/> : (
                        ...
                        <FormControl onKeyDown={sendMessage} required sx={{mt:3}}>
                        {
                            ...
                            <TextField sx={{bgcolor:'#E8E8E8'}} placeholder='Enter a message' onChange={typingHandler} value={newMessage} InputProps={{endAdornment: (
